...
},{"./array.helper.js":"src/helpers/array.helper.js"}],"src/favorites.js":[function(require,module,exports) {
"use strict";
...
var render = function render() {
  if (finalArr.length) {
    finalArr.forEach(function (_ref) {
      var flag = _ref.flag,
          index = _ref.index,
          res = _ref.res;
      var newCard = (0, _createCard.createCard)(res, flag, index, page, finalArr);
...
var searchCountries = function searchCountries(searchName) {
  divtitle.innerHTML = "<h1>SEARCH</h1>";
  divCards.innerHTML = "";
  finalArr.forEach(function (_ref2) {
    var flag = _ref2.flag,
        _ref2$res = _slicedToArray(_ref2.res, 3),
        name = _ref2$res[0],
        capital = _ref2$res[1],
        region = _ref2$res[2];

    if (name.includes(searchName)) {
      var newCard = (0, _createCard.createCard)([name, capital, region], flag);
      divCards.append(newCard);
      divCards.className = "divCards";
    }
  });
};
},{"./services/favorites.js":"src/services/favorites.js","./helpers/createCard.js":"src/helpers/createCard.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/favorites.js"], null)
